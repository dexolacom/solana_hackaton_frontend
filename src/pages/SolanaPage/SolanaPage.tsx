...
const SolanaPage = () => {
  const { data: ecosystemInvested, isLoading: isLoadingEcosystem } =
    useTotalInvested(addressEcosystemCollection);
  ...
  const tempData = {
    amount: {
      ...
      number: isLoadingEcosystem
        ? "Calculation..."
        : currencyFormatter(ecosystemInvested ?? 0),
    },
    ...ecosystemHoldings,
    description: {
      title: "Description",
