...
const ClassicPage = () => {
  const { data: classicInvested, isLoading: isLoadingClassic } =
    useTotalInvested(addressClassicCollection);
  ...
  const tempData = {
    amount: {
      ...
      number: isLoadingClassic
        ? "Calculation..."
        : currencyFormatter(classicInvested ?? 0),
    },
    ...classicHoldings,
    description: {
      title: "Description",
