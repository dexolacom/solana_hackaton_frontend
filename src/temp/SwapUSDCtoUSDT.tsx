...
const SwapUSDCtoUSDT = () => {
  ...
  const handleChange = async () => {
    ...
    const whirlpool_pubkey = PDAUtil.getWhirlpool(
      ...
      devUSDC.mint, devUSDT.mint, tick_spacing).publicKey;
    ...
    console.log("estimatedAmountIn:", DecimalUtil.fromBN(quote.estimatedAmountIn, devUSDT.decimals).toString(), "devUSDT");
